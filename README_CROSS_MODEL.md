# Runtime cross-model de CEREBRO3

Este subsistema amplía la base existente con ejecución real de modelos, observación de activaciones y validación de evidencia. No trata la respuesta del modelo, el nombre del modelo o un vector de activación como prueba de que se ha transferido una capacidad.
...
No conviene leer el runtime cross-model como una entidad que “decide por sí misma” ni como una prueba de que cualquier cambio de activación implica una mejor capacidad funcional. La mejora real exige validación adicional, bind a identidade, checks de contrato y decisión final de la autoridad.
...
El runtime HF crea un worker persistente local. Rust valida:
