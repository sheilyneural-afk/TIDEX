...
const GROUP_ID_DOMAIN: &[u8] = b"TIDEX:NUMERICAL-EVALUATION-GROUP:v1\0";
const EVIDENCE_ID_DOMAIN: &[u8] = b"TIDEX:NUMERICAL-EVIDENCE:v1\0";
const PAIR_ID_DOMAIN: &[u8] = b"TIDEX:NUMERICAL-PAIR:v1\0";
const EVALUATOR_POLICY_DOMAIN: &[u8] = b"TIDEX:NUMERICAL-EVALUATOR-POLICY:v2\0";
const LINEAGE_DOMAIN: &[u8] = b"TIDEX:NUMERICAL-EVOLUTION-LINEAGE:v1\0";
const EXPERIMENTAL_INPUT_DOMAIN: &[u8] = b"TIDEX:NUMERICAL-EXPERIMENTAL-INPUT:v1\0";
const RESEARCH_TRIAL_DOMAIN: &[u8] = b"TIDEX:NUMERICAL-RESEARCH-TRIAL:v1\0";
