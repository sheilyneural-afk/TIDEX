...
const REPORT_DOMAIN: &[u8] = b"TIDEX:PAIRED-EVALUATION:v1\0";
const GATE_DOMAIN: &[u8] = b"TIDEX:CANDIDATE-GATE:v1\0";
const METRIC_CATALOG_DOMAIN: &[u8] = b"TIDEX:METRIC-CATALOG:v1\0";
const ROBUST_POLICY_DOMAIN: &[u8] = b"TIDEX:ROBUST-EVALUATION-POLICY:v1\0";
const OBSERVATION_SET_DOMAIN: &[u8] = b"TIDEX:PAIRED-OBSERVATIONS:v1\0";
const INDEPENDENCE_DESIGN_DOMAIN: &[u8] = b"TIDEX:INDEPENDENCE-DESIGN:v1\0";
const GATE_POLICY_DOMAIN: &[u8] = b"TIDEX:CANDIDATE-GATE-POLICY:v1\0";
const PETFC_TRAJECTORY_DOMAIN: &[u8] = b"TIDEX:PETFC-TRAJECTORY:v1\0";
const PETFC_POLICY_DOMAIN: &[u8] = b"TIDEX:PETFC-POLICY:v1\0";
const PETFC_ASSESSMENT_DOMAIN: &[u8] = b"TIDEX:PETFC-ASSESSMENT:v1\0";
const PARETO_SELECTION_DOMAIN: &[u8] = b"TIDEX:PARETO-SELECTION:v1\0";
const BUDGET_POLICY_DOMAIN: &[u8] = b"TIDEX:ADAPTIVE-BUDGET-POLICY:v1\0";
const BUDGET_PLAN_DOMAIN: &[u8] = b"TIDEX:ADAPTIVE-BUDGET-PLAN:v1\0";
const CANARY_POLICY_DOMAIN: &[u8] = b"TIDEX:CANARY-POLICY:v1\0";
const CANARY_STATE_DOMAIN: &[u8] = b"TIDEX:CANARY-STATE:v1\0";
const CANARY_BUCKET_DOMAIN: &[u8] = b"TIDEX:CANARY-BUCKET:v1\0";
