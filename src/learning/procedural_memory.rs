...
const ATTEMPT_DOMAIN: &[u8] = b"TIDEX:PROCEDURAL-ATTEMPT:v4\0";
const APPLICABILITY_DOMAIN: &[u8] = b"TIDEX:SOLVER-APPLICABILITY:v2\0";
const CONFIGURATION_DOMAIN: &[u8] = b"TIDEX:SOLVER-CONFIGURATION:v2\0";
const BASE_ARTIFACT_DOMAIN: &[u8] = b"TIDEX:BASE-ARTIFACT:v1\0";
const TARGET_PROFILE_DOMAIN: &[u8] = b"TIDEX:TARGET-PROFILE:v1\0";
const SOLVER_POLICY_DOMAIN: &[u8] = b"TIDEX:SOLVER-POLICY:v1\0";
const SOLVER_CANDIDATE_DOMAIN: &[u8] = b"TIDEX:SOLVER-CANDIDATE:v1\0";
const DECLARED_BACKEND_IMPLEMENTATION_DOMAIN: &[u8] = b"TIDEX:DECLARED-BACKEND-IMPLEMENTATION:v2\0";
const EVALUATOR_POLICY_DOMAIN: &[u8] = b"TIDEX:EVALUATOR-POLICY:v1\0";
const EVALUATION_DESIGN_DOMAIN: &[u8] = b"TIDEX:EVALUATION-DESIGN:v2\0";
const LINEAGE_DOMAIN: &[u8] = b"TIDEX:PROCEDURAL-LINEAGE:v1\0";
const DRIFT_DOMAIN: &[u8] = b"TIDEX:PROCEDURAL-DRIFT:v4\0";
const OBSERVED_DRIFT_EVIDENCE_DOMAIN: &[u8] = b"TIDEX:OBSERVED-FUNCTIONAL-DRIFT-EVIDENCE:v2\0";
const SOLVER_RUN_RECEIPT_DOMAIN: &[u8] = b"TIDEX:SOLVER-RUN-RECEIPT:v2\0";
const SOLVER_CANDIDATE_REJECTION_RECEIPT_DOMAIN: &[u8] =
    b"TIDEX:SOLVER-CANDIDATE-REJECTION-RECEIPT:v1\0";
const SOLVER_RUN_FAILURE_DOMAIN: &[u8] = b"TIDEX:SOLVER-RUN-FAILURE:v4\0";
const RETRIEVAL_POLICY_DOMAIN: &[u8] = b"TIDEX:PROCEDURAL-RETRIEVAL-POLICY:v4\0";
const RESEARCH_VALIDATION_RECEIPT_DOMAIN: &[u8] = b"TIDEX:RESEARCH-VALIDATION-RECEIPT:v1\0";
const RESEARCH_REPORT_RECEIPT_DOMAIN: &[u8] = b"TIDEX:RESEARCH-REPORT-RECEIPT:v1\0";
...
enum ProceduralSchema {
    #[serde(rename = "tidex.procedural_memory/v4")]
    Current,
}
