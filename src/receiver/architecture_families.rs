...
use crate::receiver::receiver_profile::ReceiverArchitecture;
...
impl ArchitectureFamilyFingerprint {
    ...
    pub fn validate(&self) -> BrainResult<()> {
        ...
        {
            return Err(BrainError::Integrity("architecture_family_fingerprint_invalid".into()));
        }
        Ok(())
    }
}
...
pub fn fingerprint_architecture(
    ...
    {
        return Err(BrainError::Invalid("architecture_fingerprint_input_invalid".into()));
    }
...
mod tests {
    ...
    fn detects_moe_and_internal_module_families() {
        ...
        assert_eq!(report.receiver_architecture, ReceiverArchitecture::MixtureOfExperts);
    }
    ...
    fn bert_model_with_encoder_tensors_is_encoder_transformer() {
        ...
        assert_eq!(report.receiver_architecture, ReceiverArchitecture::Transformer);
    }
}
