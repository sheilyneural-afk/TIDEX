...
//! module, KnowledgeEngine/Lab receipts, and the normal governance path.
...
pub struct ExecutorDescriptor {
    ...
    pub lab_recipe_id: Option<String>,
    pub notes: String,
...
pub struct ExecutorDescriptorDraft<'a> {
    ...
    pub lab_recipe_id: Option<&'a str>,
    pub notes: &'a str,
}
...
fn derive_workflow_status(
    ...
    lab_recipe_id: Option<&str>,
) -> ExecutorWorkflowStatus {
    if lab_recipe_id.is_some() || surfaces.contains(&ExecutorSurface::TidexLab) {
        ExecutorWorkflowStatus::LabReady
...
fn derive_runtime_status(
    ...
    match (legacy_state, authority, effect, workflow) {
        ...
        (ExecutorState::OperationalNeedsWorkflow, _, _, ExecutorWorkflowStatus::LabReady)
        ...
        (ExecutorState::Operational, _, _, ExecutorWorkflowStatus::LabReady)
...
fn derive_actionable_now(
    surfaces: &[ExecutorSurface],
    lab_recipe_id: Option<&str>,
) -> bool {
    lab_recipe_id.is_some()
        || surfaces.contains(&ExecutorSurface::TidexCli)
        || surfaces.contains(&ExecutorSurface::TidexLab)
        || surfaces.contains(&ExecutorSurface::Binary)
}
...
impl ExecutorDescriptor {
    pub fn new(draft: ExecutorDescriptorDraft<'_>) -> BrainResult<Self> {
        let workflow_status =
            derive_workflow_status(draft.state, draft.surfaces, draft.lab_recipe_id);
        ...
        let mut value = Self {
            ...
            actionable_now: derive_actionable_now(draft.surfaces, draft.lab_recipe_id),
            ...
            produces: draft
                ...
                .map(|item| (*item).to_string())
                .collect(),
            lab_recipe_id: draft.lab_recipe_id.map(str::to_string),
    ...
    fn validate_without_digest(&self) -> BrainResult<()> {
        if self.schema != "cerebro.tidex.executor_descriptor/v1"
            ...
            || self.produces.iter().any(|item| item.trim().is_empty())
            || self.requires.iter().any(|item| item.trim().is_empty())
        {
        ...
        if self.implementation_status == ExecutorImplementationStatus::Missing {
            return Err(BrainError::Invalid(
                "executor_descriptor_implementation_missing".into(),
            ));
        }
        ...
        {
            return Err(BrainError::Invalid(
                "executor_actionable_runtime_mismatch".into(),
            ));
        }
        ...
        {
            return Err(BrainError::Invalid(
                "executor_lifecycle_authority_mismatch".into(),
            ));
        }
        ...
        {
            return Err(BrainError::Invalid(
                "executor_authority_effect_mismatch".into(),
            ));
        }
        Ok(())
    }
    ...
    pub fn validate(&self) -> BrainResult<()> {
        ...
        if descriptor_digest(self)? != self.descriptor_sha256 {
            return Err(BrainError::Integrity(
                "executor_descriptor_digest_mismatch".into(),
            ));
        }
        Ok(())
    }
...
pub fn executor_catalog() -> BrainResult<Vec<ExecutorDescriptor>> {
    let values = vec![
        ...
        desc!(
            ...
            Planner,
            PlanningOnly,
            [TidexCli, TidexLab, InternalLibrary],
        ...
        desc!(
            ...
            ["authority_instance", "authenticated_precommit_reference", "capability_bundle", "knowledge_state"],
        ...
        desc!(
            ...
            ["training_problem", "holdout_groups", "explicit_governance_policy"],
        ...
        desc!(
            ...
            ["start_learning", "next_aperture", "assimilate_evidence", "inspect_learning_session"],
            ["learning_target", "adaptive_policy", "authenticated_experiment_evidence"],
        ...
        desc!(
            ...
            ["completed_adaptive_session", "sealed_representation_evidence"],
        ...
        desc!(
            ...
            RuntimeIntervention,
            [CoreEngine, Binary, InternalLibrary],
            ["train_controller", "inspect_controller", "compose_controller"],
            ["authenticated_controller_dataset", "controller_policy", "promoted_state_binding"],
            ["learned_controller_receipt", "recorded_controller_execution"],
            None,
        ...
        desc!(
            ...
            ["skill_fields", "curvature", "causal_credit"],
        ...
        desc!(
            ...
            AdvisorySignal,
            [CoreEngine, InternalLibrary],
            ["phase_correlation", "sbas_time_series", "persistent_scatterers"],
        ...
        desc!(
            ...
            EvidenceProducer,
            ReadOnlyEvidence,
            [CoreEngine, TidexCli, TidexLab, InternalLibrary],
            ["functional_structure_reconstruction"],
            ["authenticated_observed_deltas"],
            ["skill_fields", "identifiability_report", "tomography_receipt"],
        ...
        desc!(
            ...
            EvidenceProducer,
            ReadOnlyEvidence,
            [CoreEngine, TidexCli, TidexLab, Binary],
        ...
        desc!(
            ...
            ["frozen_compiler", "capability_ir"],
            ["candidate_delta_plan"],
        ...
        desc!(
            ...
            ["compiled_candidate", "base_checkpoint"],
        ...
        desc!(
            ...
            ["universal_plan_request", "universal_plan_receipt", "receiver_layout"],
        ...
        desc!(
            ...
            ["universal_plan_request", "universal_plan_receipt", "receiver_layout", "low_rank_policy"],
        ...
        desc!(
            ...
            ["universal_plan_request", "universal_plan_receipt", "receiver_layout", "sparse_policy"],
        ...
        desc!(
            ...
            ["universal_plan_request", "universal_plan_receipt", "receiver_layout", "steering_layout", "steering_policy"],
        ...
        desc!(
            ...
            Some("adapter.status"),
            "Only production lifecycle authority for adapters."
        ),
        desc!(
            "adapter.import",
        ...
        desc!(
            ...
            [TidexCli, TidexLab],
            ["compose_adapters"],
            ["ordered_adapter_ids", "adapter_bank_state"],
        ...
        desc!(
            ...
            ["candidate_adapter_artifact", "adapter_materialization_receipt"],
        ...
        desc!(
            ...
            ["sealed_gate_witnesses", "current_bank_state"],
        ...
        desc!(
            ...
            [TidexCli, TidexLab],
            ["revoke_adapter"],
            ["revocation_request", "current_bank_state"],
        ...
        desc!(
            ...
            "tidex_lab_runner::probe_runtime",
            "cross_model/models",
            Operational,
            EvidenceProducer,
            ReadOnlyEvidence,
        ...
        desc!(
            ...
            "tidex_lab_runner::ActivationTransferExperiment",
            "cross_model/extraction",
            ExperimentalCandidateOnly,
            Executor,
            RuntimeIntervention,
        ...
        desc!(
            ...
            ["runtime_profile.deep_instrumentation", "module_path", "prompt"],
        ...
        desc!(
            ...
            ["runtime_profile.sparse_autoencoder_analysis", "sae_release", "sae_id", "module_path", "prompt"],
            ["sparse_feature_evidence"],
            Some("lab.direct_runner"),
            "Operational when the selected model profile exposes sparse_autoencoder_analysis=true and the requested SAE release/id resolves locally."
        ),
        desc!(
            "plasticity.bcm",
            "BCM metaplasticity",
            ...
            ["threshold_signal"],
            None,
            "Implemented but not yet fed by Lab/Knowledge jobs."
        ),
        desc!(
        ...
        desc!(
            ...
            ["modulated_rate"],
            None,
            "Signal combiner; cannot alter hard gates."
        ),
        desc!(
            "plasticity.routing",
            "Routing plasticity",
            ...
            ["routing_decision"],
            None,
            "Needs robust catalog identity and Lab outcome feeds."
        ),
        desc!(
            "plasticity.content",
            "Content plasticity",
            ...
            None,
            "Implemented but not yet part of an operator workflow."
        ),
        desc!(
            "plasticity.pi",
            "PI controller",
            ...
            None,
            "Useful only after defining controlled variables."
        ),
        desc!(
            "plasticity.elo",
            "ELO result ranking",
            ...
            ["elo_rating_update"],
            None,
            "Should consume Lab job outcomes; not promotion evidence by itself."
        ),
        desc!(
            "coevolution.loop",
            ...
            None,
            "Analyzer, not executor authority."
        ),
        desc!(
            "consensus.builder",
            "Consensus builder",
        ...
        desc!(
            ...
            ["lab_job_record", "lab_evidence_receipt"],
            None,
...
pub fn validate_catalog(
    ...
    for value in &mut values {
        ...
        if !ids.insert(value.executor_id.clone()) {
            return Err(BrainError::Integrity(
                "executor_descriptor_duplicate".into(),
            ));
        }
    }
...
pub fn executor_for_lab_recipe(recipe_id: &str) -> BrainResult<Option<ExecutorDescriptor>> {
    let matches = executor_catalog()?
        .into_iter()
        .filter(|entry| entry.lab_recipe_id.as_deref() == Some(recipe_id))
        .collect::<Vec<_>>();
    if matches.len() == 1 {
...
mod tests {
    ...
    fn catalog_is_valid_and_unique() {
        ...
        assert_eq!(
            ...
            Some((
                ExecutorState::ArchitectureOnly,
                false,
                ExecutorMaturity::OperationalAdvisory
            ))
        );
    ...
    #[test]
    fn registry_preserves_declared_advisory_state() {
        let values = executor_catalog().unwrap();
        let bcm = values
            .iter()
            .find(|entry| entry.executor_id == "plasticity.bcm")
        ...
        assert_eq!(bcm.state, ExecutorState::ArchitectureOnly);
        assert_eq!(
            bcm.runtime_status,
            ExecutorRuntimeStatus::AdvisoryFromEvidence
        );
        assert!(!bcm.actionable_now);
    }
